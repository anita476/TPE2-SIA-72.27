...
def parse_arguments() -> argparse.Namespace:
    ...
    argument_parser.add_argument("--temperature", type=float, default=1.0, help="Initial temperature T_0 for Boltzmann selection (fitness is normalized to [0,1] internally)")
    argument_parser.add_argument("--temperature-min", type=float, default=0.1, help="Convergence temperature T_c for Boltzmann selection")
    argument_parser.add_argument("--temperature-decay", type=float, default=-0.001, help="Decay constant k for Boltzmann schedule: T(t) = T_c + (T_0 - T_c) * e^(k*t), k < 0 for cooling")
    argument_parser.add_argument("--target-fitness", type=float, default=None, help="Stop when best fitness >= this value")
